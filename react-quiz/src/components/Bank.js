...
function reducer(state, action) {
  switch (action.type) {
    ...
    case "payLoan":
      const remainLoan = state.loan - state.balance;
      const remainBalance = state.balance - state.loan;
      return {
        ...state,
        loan: remainLoan < 0 ? 0 : remainLoan,
        balance: remainBalance < 0 ? 0 : remainBalance,
      };
    case "closeAccount":
